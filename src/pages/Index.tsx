        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl flex items-center justify-center">
              <img src={feiraIcon} alt="Feira Fácil" className="w-6 h-6" style={{ filter: 'brightness(0) invert(1)' }} />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="https://wa.me/5562991429264" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">WhatsApp</a></li>
                <li><a href="mailto:feirafacilbrasil@gmail.com" className="hover:text-white transition-colors">E-mail</a></li>
              </ul>
            </div>
            <div>
