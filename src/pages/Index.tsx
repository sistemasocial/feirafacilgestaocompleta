...
const Index = () => {
  ...
  const benefits = ["Interface intuitiva e fácil de usar", "Controle completo de pagamentos e status", "Relatórios detalhados de vendas e desempenho", "Sistema de regras e políticas automatizado", "Acesso diferenciado para administradores e feirantes", "Suporte a múltiplas formas de pagamento"];
  return <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-yellow-50/30">
      {/* Header */}
      ...
      <section className="relative py-20 px-6 overflow-hidden">
        ...
        backgroundImage: `url(${feiraBackground})`
      }}>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-6xl font-light text-gray-800 leading-tight">
                  Gestão Completa de <span className="font-semibold text-emerald-600">Feiras Livres e Feiras Exclusivas!      </span>
                </h1>
                <p className="text-xl text-gray-600 leading-relaxed">
                  A  Única  plataforma profissional para administrar sua feira livre com controle de feirantes, pagamentos, vendas e muito mais.
                </p>
              </div>
              ...
              <div className="flex items-center space-x-8 pt-4">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-gray-800">12.500+</div>
            ...
            <div className="relative">
              ...
              <div className="absolute -top-4 -left-4 bg-white rounded-2xl p-4 shadow-xl border border-gray-100">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-gray-800">12,500 mil</div>
              ...
              <div className="absolute -bottom-4 -right-4 bg-white rounded-2xl p-4 shadow-xl border border-gray-100">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-gray-800">R$ 250 mil</div>
      ...
      <section id="recursos" className="py-20 px-6 bg-white/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => <div key={index} className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:scale-105">
      ...
      <section id="vantagens" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {benefits.map((benefit, index) => <div key={index} className="flex items-center space-x-4 p-6 bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-100">
      ...
      <section id="contato" className="py-20 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <a href="https://wa.me/5562991429264" target="_blank" rel="noopener noreferrer" className="bg-white border border-gray-200 p-6 rounded-2xl hover:shadow-lg transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-3">
            ...
            <a href="mailto:feirafacilbrasil@gmail.com" className="bg-white border border-gray-200 p-6 rounded-2xl hover:shadow-lg transition-all duration-300 hover:scale-105 flex items-center justify-center space-x-3">
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-emerald-500 to-emerald-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={() => navigate("/auth")} className="bg-white text-emerald-600 px-8 py-4 rounded-2xl text-lg font-semibold hover:shadow-xl transition-all duration-300 hover:scale-105 whitespace-nowrap">
              Começar Gratuitamente
            </button>
            <button onClick={() => navigate("/install")} className="border-2 border-white text-white px-8 py-4 rounded-2xl text-lg font-medium hover:bg-white/10 transition-all duration-300 whitespace-nowrap flex items-center justify-center gap-2">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-400">A plataforma mais completa para gestão de feiras livres e Exclusivas do Brasil.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <a href="https://wa.me/5562991429264" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                    WhatsApp
                  </a>
                </li>
                <li>
