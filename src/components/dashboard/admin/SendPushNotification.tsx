...
import { FcmTokensDiagnostics } from "./FcmTokensDiagnostics";
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Envie notificações push para todos os feirantes cadastrados que têm tokens FCM válidos
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {fcmTokensCount === 0 ? (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                <div className="space-y-2">
                  ...
                  <p className="text-sm">
                    Nenhum feirante tem token FCM registrado. Verifique o diagnóstico acima.
                  </p>
                </div>
              </AlertDescription>
            </Alert>
            ...
            <Alert>
              ...
              <AlertDescription>
                {fcmTokensCount} dispositivo(s) registrado(s) para receber notificações.
              </AlertDescription>
            </Alert>
          )}
          ...
          <Button
            ...
            disabled={loading || !title || !message || fcmTokensCount === 0}
            className="w-full"
          >
            <Send className="w-4 h-4 mr-2" />
            {loading ? "Enviando..." : `Enviar para ${fcmTokensCount} Dispositivo(s)`}
          </Button>
        </CardContent>
      </Card>
    </div>
